...
part of 'competitions_api_services.dart';
...
class _CompetitionsApiService implements CompetitionsApiService {
  ...
  @override
  Future<HttpResponse<dynamic>> getPopularLeagues() async {
  ...
  @override
  Future<HttpResponse<dynamic>> getLeagueDetailsById(int leagueId) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> getLeagueLogoById(int leagueId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'leagueid': leagueId};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
